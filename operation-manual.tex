...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{feros/FEROS-badscanlinks-2.jpg}
...
If all FEROS systems are ONLINE but the test OB or any other OB crashes with an FIERA related error \figref{feros_fiera_0}, try the following steps:'
...
\begin{enumerate}
	...
	\procedure{Power-cycle \Gls{feros} FIERA}
	\label{proc:feros_fiera_powercycle}
	\begin{enumerate}
		\item go to the VME room in the dome and look for the SLCU \gls{wfefcd}. Switch it off.
		\item Go to FEROS room and switch off the power for FIERA (\figref{feros_fiera}),the power switch is on the back-side of the lower part (\figref{feros_fiera_1}). Wait 10 seconds and switch the power back on.
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{feros/feros_fiera_0.png}
...
\begin{figure}[t!]
\begin{minipage}{0.48\linewidth}
\subfigure[\Gls{feros} FIERA in the FEROS room.]{%
\includegraphics[angle=270,width=\linewidth]{feros/FEROS_FIERA_2.jpg}
\label{fig:feros_fiera_2}
}
\end{minipage}
\hspace{0.02\linewidth}
\begin{minipage}{0.48\linewidth}
\subfigure[The backside of the power supply for \gls{feros} FIERA.]{
\includegraphics[angle=270,width=\linewidth]{feros/FEROS_FIERA_1.jpg}
\label{fig:feros_fiera_1}
		}
\end{minipage}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{wfi/wfiselftest.png}
...
\url{http://134.171.103.200/camera/index.html#/video}
